  ...
  return (
    <BackgroundOverlay src={background} alt="Scottish Parliament">
      <div className={styles.root}>
        ...
        <p>In the future, I would like to work as a web or software developer. I have recently secured a summer internship and a placement for my industrial experience year. I am looking forward to the experience that these placements will bring.</p>
